...
- Active Workspace: ${sessionCtx.workspace || wsName || "default"}`;
	...
	systemPrompt += `\n\nCRITICAL RULES:
- STRICT BREVITY: Every answer must be ultra-compact, direct to the point, and strictly within 1 to 2 sentences (maximum 3 sentences if synthesizing extensive history).
...
- PURE VOCABULARY INTEGRITY: Always use standard, authentic, dictionary-recognized vocabulary in the target language. Strictly avoid inventing hybrid slang, portmanteaus, or synthetic compound words (such as combining local affixes with foreign loan words or fabricating non-existent morphological blends). Maintain simple, direct, and natural sentence structures.
