  ...
  factory: (require) => {
    ...
    if (typeof document !== "undefined" && !document.getElementById("dsh-btw-spin-style")) {
      ...
      style.textContent = `
        ...
        @keyframes dsh-pulse-bar { 0%, 100% { opacity: 0.35; transform: scaleX(0.98); } 50% { opacity: 0.85; transform: scaleX(1); } }
      `;
          ...
          ? React.createElement("div", {
              ...
              React.createElement("div", {
                style: {
                  ...
                  height: 11,
                  borderRadius: 4,
                  background: "linear-gradient(90deg, rgba(255, 255, 255, 0.05) 0%, rgba(59, 130, 246, 0.16) 50%, rgba(255, 255, 255, 0.05) 100%)",
                  animation: "dsh-pulse-bar 1.5s ease-in-out infinite",
              ...
              React.createElement("div", {
                style: {
                  ...
                  height: 11,
                  borderRadius: 4,
                  background: "linear-gradient(90deg, rgba(255, 255, 255, 0.04) 0%, rgba(59, 130, 246, 0.12) 50%, rgba(255, 255, 255, 0.04) 100%)",
                  animation: "dsh-pulse-bar 1.5s ease-in-out infinite 0.25s",
                  transformOrigin: "left"
                }
              })
            )
