        ...
        React.createElement("svg", {
          ...
          React.createElement("path", {
            ...
            style: {
              ...
              transformOrigin: "120px 18px",
              opacity: 0.35
            },
            d: "M 8 18 L 34 18 Q 40 18, 44 11 T 52 25 T 60 9 T 68 27 T 76 10 T 84 26 T 92 11 T 100 25 T 110 12 T 120 24 T 130 14 T 140 22 T 152 15 T 164 21 T 176 16 T 188 20 T 200 17 T 212 19 T 225 18 L 392 18"
          }),
          React.createElement("path", {
            stroke: "#3b82f6",
            strokeWidth: 2,
            ...
            strokeLinejoin: "round",
            style: {
              animation: "dsh-soundwave-dance 1.8s ease-in-out infinite, dsh-soundwave-glow 2.2s ease-in-out infinite",
              transformOrigin: "120px 18px"
            },
            d: "M 8 18 L 30 18 Q 36 18, 40 8 L 44 28 L 48 10 L 52 26 L 57 4 L 63 32 L 68 6 L 73 30 L 78 7 L 83 29 L 88 8 L 93 28 L 98 10 L 103 26 L 109 11 L 115 25 L 121 12 L 127 24 L 134 13 L 141 23 L 148 14 L 155 22 L 163 15 L 171 21 L 179 16 L 187 20 L 196 17 L 205 19 L 215 17.5 L 225 18.5 L 235 18 L 392 18"
          })
        )
      )
    );
    ...
    if (typeof document !== "undefined" && !document.getElementById("dsh-btw-spin-style")) {
      ...
      style.textContent = `
        ...
        @keyframes dsh-soundwave-dance {
          ...
          35% { transform: scaleY(1.18); opacity: 1; }
          70% { transform: scaleY(0.85); opacity: 0.9; }
        }
        @keyframes dsh-soundwave-glow {
          0%, 100% { filter: drop-shadow(0 0 2px rgba(59, 130, 246, 0.6)) drop-shadow(0 0 6px rgba(59, 130, 246, 0.3)); }
          50% { filter: drop-shadow(0 0 5px rgba(59, 130, 246, 0.95)) drop-shadow(0 0 12px rgba(59, 130, 246, 0.55)); }
        }
      `;
