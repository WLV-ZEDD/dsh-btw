window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    if (typeof document !== "undefined" && !document.getElementById("dsh-btw-spin-style")) {
      ...
      style.textContent = "@keyframes dsh-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }";
      ...
      return React.createElement("section", {
        ...
        !collapsed && React.createElement("div", {
          ...
          ? React.createElement("div", {
              ...
              React.createElement(IconSpinner, { size: 14, color: "#3b82f6" }),
              React.createElement("span", null, "Thinking on the side...")
            )
          : (currentItem.answer && currentItem.answer.startsWith("Unable to resolve side question:")
              ? React.createElement("div", {
                  style: {
